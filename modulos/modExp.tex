 ...
 grupos.\\
    ...
    \begin{cdtEntidad}{ConfigXPVisual}{Configuración de los Niveles}{}
        ...
        \brAttr{message}{Mensaje}{tText}{%
            Cadena que contiene el mensaje de felicitaciones que tienen por defector todos
            los niveles.\par
        ...
        \brAttr{colorLvl}{Color de número de nivel}{tColor}{%
            Valor que contiene el código de color con el cual se printará el número de nivel.\par
...
\section{Casos de Uso}
    ...
    \addfigure{1}{modulos/CU/UseCases}{fig:CUEDiagram}{Diagrama de casos de uso del Módulo de Experiencia} \clearpage
...
%    \addfigure{1}{diagrams/UseCases}{fig:expUsecase}{Diagrama de casos de uso}
    ...
    %\input{CU/cu-e1}\clearpage % Configurar esquema de experiencia

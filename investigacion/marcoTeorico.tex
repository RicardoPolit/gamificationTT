...
\label{ch:marcoTeorico}
 ...
 \input{investigacion/marcoTeorico/frameworks}
...
\addfigure{0.8}{investigacion/images/PluginFiles}{fig:pluginFiles}{Organización de los archivos presentes en la mayoría de los plugins}

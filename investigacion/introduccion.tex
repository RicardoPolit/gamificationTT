...
% GAMIFICATION =  GAME THINKING + BUSINESS KNOWLEDGE
 ...
 principales objetivos del curso \cite{FrameWorkForTheWin}.\\
...
% LA GAMIFICACIÓN NO ES TRIVIAL, REQUIERE ANALISIS, DISEÑO, RELIZACION DE PRUEBAS y AJUSTES
 ...
 \cite[p. 39]{Octalysis}, \cite{FrameWorkForTheWin}, \cite[p. 1110]{GamInE-Learning}.\\

% LA TECNOKOLGÏA PODRIA AYUDAR A UNA MAYOR ADOPCIÖN Y MAS INVESTIGACIONES

 \noindent El uso de herramientas de tecnólógicas puede ayudar crear una experiencia gamificada de una
...
% MOTIVACIÓN
 ...
 apoyar a la educación que hemos recibido brindando un herramienta que ayude a realizar más investigaciones
 relacionadas al tema de la gamificación, brindar a los profesores una herramienta para hacer sus cursos más

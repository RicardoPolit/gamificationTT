...
\noindent Los documentos de investigación listados en la tabla \ref{tbl:mappingStudy} forman parte de un estudió (ver \cite{mappingStudy}) donde se filtrarón de entre 1600 documentos, los artículos de investigación que documentan la forma en que se implementó la gamificación y además detallan los resultados obtenidos derivados del análisis del caso de estudio.

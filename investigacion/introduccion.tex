...
\noindent Los documentos de investigación listados en la tabla \ref{tbl:mappingStudy} fueron elegidos dentro de un total de 1600 documentos relacionados a la gamificación, gracias al estudio {\em ''Gamifcation in Education: A Systematic Mapping Study''} \cite{mappingStudy}. La lista fue enriquecida, buscando los detalles de implementación y conclusiones generales de cada documento de investigación listado.
...
directamente con el entorno educativo y clase a clase obtienen conocimiento de forma empírica 
acerca de qué mecánicas de juegos brindan resultados positivos en el aula. Cuando uno de estos
profesores desea implementar gamificación en un curso mixto o en linea, normalmente buscará
en los principales sistemas de aprendizaje en línea la forma en que podría implementarla.\\

    Mediante la investigación realizada en el \nameref{sec:estadoArte} se encontró que:
...
\noindent La investigación presente en el estado del arte contiene los principios de gamificación
a los que los sistemas brindaban soporte, la forma en que lo hacian y los componentes externos que
permitían añadir funcionalidades entorno a la gamificación.
...
\noindent De la misma forma, se buscará que los componentes puedan trabajar de forma colaborativa
sin depender completamente entre los mismos, con la finalidad de que a nivel curso y a nivel plataforma
se puedan habilitar exactamente los componentes que se quieran incluir en los cursos.\\
...
\noindent La herramienta a desarrollar estará compuesta por componentes de gamificación los cuales brindararán
soporte a la implementación de principios de gamificación, dichos componentes serán ampliamente configurables
con la finalidad de brindar un mayor soporte a las necesidades del administrador de la plataforma, profesores
y alumnos.\\

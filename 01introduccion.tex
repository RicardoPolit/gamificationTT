...
\noindent La \bb{Parte I: Investigación} contiene a los siguientes capítulos:%

    \begin{itemize}
        \item \nameref{ch:marcoTeorico}, que establece el soporte conceptual y documental, 
        especifica los marcos de trabajo usados y además contiene la elección de la 
        plataforma base.
        
        \item \nameref{ch:curvaAprendizaje}, que presenta los resultados obtenidos durante 
        las pruebas de concepto, los problemas encontrados y las soluciones o alternativas 
        propuestas a dicho problemas.
    
        \item \nameref{ch:modAlcance}, especifica a los actores y requerimientos funcionales
        ...
        \item \nameref{ch:modDominio}, que contiene el esquema relacional de la base de 
...
\noindent Posteriormente a la investigación se decidió destinar una parte de este documento a cada módulo identificado. Los módulos son \bb{Experiencia}, \bb{Recompensa}, \bb{Financiero}, \bb{Personalización}, \bb{Competencia} y \bb{Seguimiento}. Cada parte contiene el análisis, diseño y pruebas del módulo correspondiente.\\
\clearpage
...
La Gamificación es un anglicismo proveniente del término en ingles {\it``Gamification''}, la palabra más cercana en el lenguaje español para referirse a la Gamificación es {\it''ludificación''}. Sin embargo, ninguna de las dos palabras se encuentra definida en el Diccionario del español de México, o en el diccionario de la Real Academia de la lengua Española. A continuación se presentan las definiciones propuestas por distintos autores.
    ...
    \begin{itemize}
        ...
        que logren sus objetivos''} \cite{definicion3} % (según lo citado en Burke, 2014)
        ...
        promover el aprendizaje y resolver problemas''} \cite{definicion4} % (2012)
        ...
        \item Huotari y Hamari proporcionan una definición desde una perspectiva de marketing
         ...
         experiencias de juego para respaldar la creación de valor general del usuario''} \cite{definicion6}  %(p. 20). (2012)
        
        \item Deterding, Khaled, Nacke y Dixon \textit{``Gamificación es el uso de elementos 
        presentes en el diseño de juegos en contextos distintos a los juegos''} \cite{definicion7} %(p. 2). (2011) 

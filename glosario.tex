...
\begin{glosario}{E}
    \item[Experiencia] La experiencia o puntos de experiencia son un valor que permite cuantificar la expertiz que un usuario tiene en un juego. Comunmente son denotados por las abreviaciones 'xp' o 'exp'.
\end{glosario}

\begin{glosario}{L}
    \item[Logro] Elemento distintivo que señala la completitud de una acción o conjunto de acciones relevantes en un juego.
\end{glosario}

\begin{glosario}{N}
    \item[Nivel] Posición que un jugador tiene basada en la cantidad de puntos de experiencia \cite[p. 197]{conveptosVJNiveles}.
\end{glosario}

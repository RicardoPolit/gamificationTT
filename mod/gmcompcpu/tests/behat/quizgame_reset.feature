@mod @mod_gmcompcpu
Feature: gmcompcpu reset
  In order to reuse past gmcompcpu activities
  As a teacher
  ...
  Background:
    ...
    And user "student1" has played "Test gmcompcpu name" with a score of "10110"
    And user "student2" has played "Test gmcompcpu name" with a score of "20202"

  Scenario: Use course reset to remove all playthroughs.
    Given I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Test gmcompcpu name"

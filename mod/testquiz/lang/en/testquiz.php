...
$string['eventgamestarted'] = 'TestQuiz game started';
$string['eventgamescoreadded'] = 'TestQuiz score recorded';
$string['eventgamescoresviewed'] = 'TestQuiz scores viewed';
...
TestQuiz is an activity module that loads quiz questions from the course it\'s added to. The possible answers come down as space ships and you have to shoot the correct one.

**Note**: TestQuiz is designed to promote learning rather than for assessment. Students will have infinite attempts with instant feedback. For this reason, only add questions you want students to learn the answer to, rather than questions you want to assess if they have learned';
$string['modulenameplural'] = 'TestQuiz games';
$string['modulename'] = 'TestQuiz';
...
$string['pluginadministration'] = 'TestQuiz administration';
$string['pluginname'] = 'TestQuiz';
$string['playerscores'] = 'Player scores';
$string['privacy:metadata:testquiz_scores'] = 'Information about the user\'s chosen answer(s) for a given choice activity';
$string['privacy:metadata:testquiz_scores:testquizid'] = 'The ID of the testquiz activity the user is providing answer for';
$string['privacy:metadata:testquiz_scores:score'] = 'The score of the user during that playthrough.';
$string['privacy:metadata:testquiz_scores:timecreated'] = 'The timestamp indicating when the testquiz was played by the user';
$string['privacy:metadata:testquiz_scores:userid'] = 'The ID of the user playing this testquiz activity';
...
**Note**: TestQuiz is designed to promote learning rather than for assessment. Students will have infinite attempts with instant feedback. For this reason, only add questions you want students to learn the answer to, rather than questions you want to assess if they have learned';
$string['testquizfieldset'] = 'Custom example fieldset';
$string['testquizname_help'] = 'What is the name of this TestQuiz?';
$string['testquizname'] = 'TestQuiz name';
$string['testquiz'] = 'TestQuiz';
$string['testquiz:addinstance'] = 'Add a TestQuiz instance';
$string['testquiz:view'] = 'View TestQuiz';
$string['testquiz:viewallscores'] = 'View player scores';

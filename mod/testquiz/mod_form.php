...
/**
 * The main testquiz configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_testquiz_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('testquizname', 'testquiz'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'testquizname', 'testquiz');
        ...
        $mform->addElement('selectgroups', 'questioncategory', get_string('questioncategory', 'testquiz'), $categories);
        $mform->addHelpButton('questioncategory', 'questioncategory', 'testquiz');
    ...
    public function add_completion_rules() {
        ...
        $group[] =& $mform->createElement('checkbox', 'completionscoreenabled', '',
                get_string('completionscore', 'testquiz'));
        ...
        $mform->addGroup($group, 'completionscoregroup',
                get_string('completionscoregroup', 'testquiz'), array(' '), false);
        $mform->disabledIf('completionscore', 'completionscoreenabled', 'notchecked');
        $mform->addHelpButton('completionscoregroup', 'completionscoregroup', 'testquiz');

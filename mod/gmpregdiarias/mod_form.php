...
/**
 * The main gmpregdiarias configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gmpregdiarias_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('gmpregdiariasname', 'gmpregdiarias'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'gmpregdiariasname', 'gmpregdiarias');

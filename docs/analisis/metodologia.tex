...
\subsubsection{Equipo de desarrollo}
 ...
 Durante este trabajo el equipo de desarrollo estará conformado por tres integrantes,
...
\subsubsection{Revisión}
 ...
 en dos fases% , aplicando la primer fase a los sprints impares y las cuatro fases
 % para sprints pares.
 Las fases de describen a continuación:
    ...
    % \item[\it Fase 4]
        % Se avisa a los Stakeholders acerca de cuales observaciones procedieron
        % y cuales no.\\
    \end{itemize}
 ...
 %\noindent \message{^^JWarning WE DONT RESPECT THE STABLISHED SPRINT REVIEW pp.\thepage}  %Ricardo: no entiendo porque pone eso, y luego en ingles
...
\label{analisis:forthewin}
 ...
 estos pasos se encuentra en las siguientes secciones de este capítulo de análisis.
    ...
    \item El cuarto paso del marco de trabajo consiste en definir los ciclos de
          ...
          la sección \hyperrefx{analisis:visionyuso}.\\

...
\section{Estudio de factibilidad de implementación sobre moodle}
    ...
    \input{analisis/factibilidad/basededatos}
    \clearpage

    %\input{analisis/factibilidad/flie.tex} %{Instalación}
    %\input{analisis/factibilidad/flie.tex} %{Block Simple HTML}
    %\input{analisis/factibilidad/flie.tex} %{XMLCreator}
    %\input{analisis/factibilidad/flie.tex} %{Events API}
    %\input{analisis/factibilidad/flie.tex} %{DML API y DDL API}
    %\input{analisis/factibilidad/flie.tex} %{Javascript AMD}
    %\input{analisis/factibilidad/flie.tex} %{External Pages}
    %\input{analisis/factibilidad/flie.tex} %{Forms Validation}
    %\input{analisis/factibilidad/flie.tex} %{Tables}
    %\input{analisis/factibilidad/flie.tex} %{AJAX AlongSide Moodle}

\begin{comment}
\subsubsection{Estableciendo el entorno de desarrollo}

...
\label{ch:marcoTeorico}
 ...
 Este capítulo tiene como propósito establecer el soporte conceptual y documental del
 proyecto, especifica la metodología incluyendo roles, eventos y artefactos, además
 se especifican los marcos de trabajo de gamificación y los sistemas de aprendizaje
 contemplados, finalmente se presenta la elección de la plataforma sobre la cual se
 desarrollaron las distintas funcionalidades.
...
\label{sec:sistemasaprendizaje}
 ...
 la plataforma sobre la cual se desarrollaron los distintos componentes de gamificación.
...
\section{Moodle}\label{sec:moodle}
 ...
 Moodle hace referencia al acrónimo en inglés {\it Modular Object Oriented Dynamic
 ...
 \noindent Moodle es proporcionado gratuitamente como programa de código abierto,
 bajo la licencia GNU-GPL (GNU General Public License), esta licencia permite que
 Moodle sea adecuado y personalizado libremente ya que su configuración modular y
 diseño inter-operable permite a los desarrolladores crear plugins e integrar
 aplicaciones externas para lograr funcionalidades específicas \cite{aboutMoodle}.
...
\subsection{Arquitectura de Moodle}
 ...
 \noindent Debido a que Moodle está conformado tanto de elementos requeridos (núcleo y subsistemas)
...
\subsection{Requerimientos}
 ...
 % https://docs.moodle.org/dev/Moodle_3.5_release_notes
    ...
    \begin{itemize}
        \item PHP Versión 7.0 como mínimo, PHP 7.1.x y 7.2.x también son soportados.

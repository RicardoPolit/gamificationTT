...
\subsubsection{IU-M02a Validación del plugin a instalar}
 ...
 archivo de plugin comprimido con base en la regla \refElem{BR-M01}. Esta pantalla dirá Si el archivo
 esta formado correctamente o no, además de las acciones adicionales que se llevarán a cabo.

    \IUfig{1}{modulos/moodle/IU/InstallZIPValidacion}{IU-M02a}{Validación del plugin a instalar}

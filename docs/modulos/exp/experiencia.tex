...
\subsubsection*{Diagrama de casos de uso}
 ...
 e instructivos como documentación de las funcionalidades que brinda.
    ...
    \input{modulos/exp/CU/CU-E05}   % Comvertir un curso ordinario a uno gamificado
...
\subsubsection{Interfaces de Moodle}
    ...
    \input{modulos/moodle/IU/IU-M03}  % Resultado Instalación Plugin
    \input{modulos/moodle/IU/IU-M03a} % Resultado Instalación Plugin
    \input{modulos/moodle/IU/IU-M04}  % Resultado Instalación Plugin
    \input{modulos/moodle/IU/IU-M04a} % Resultado Instalación Plugin
    \input{modulos/moodle/IU/IU-M05}  % Resultado Instalación Plugin
    \input{modulos/moodle/IU/IU-M05a} % Resultado Instalación Plugin
    \input{modulos/moodle/IU/IU-M05b} % Resultado Instalación Plugin
    \input{modulos/moodle/IU/IU-M05c} % Resultado Instalación Plugin

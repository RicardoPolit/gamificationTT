...
{BR-E05}{Cálculo de experiencia del nivel con incremento linea} % Cuando están iniciados
 ...
 \BRsection[control]{Atributos}
    ...
    \BRitem{Descripción}{%
        ...
        incremento es lineal está dado por la siguiente fórmula: Sea {\it exp()}
        la función que optiene la experiencia de un nivel en específico, sea tambien
        $i$ el nivel del cual se calcula la experiencia, y finalmente sea $inc$ el
        factor de incremento de nivel a nivel.
...
%   }%
    ...
    \BRitem{Ejemplo positivo}{\hfill\par%
        ...
        \item La experiencia requerida para superar el nivel 1 es de 2000 puntos y el
              factor de incremento entre los niveles es de 500 puntos, entonces la
              experiencia requerida para pasar el nivel 5 es de 4500 puntos.
        \end{itemize}
    }
    ...
    \BRitem{Ejemplo negativo}{\hfill\par%
        ...
        \item La experiencia requerida para superar el nivel 1 es de 2000 puntos y el
              factor de incremento entre los niveles es de 500 puntos, entonces la
              experiencia requerida para pasar el nivel 5 es de 3000 puntos.
        \end{itemize}
    }% 

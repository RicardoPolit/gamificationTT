...
%
 Permite al \refElem{aAdministrador} que cuando se elimine a algun alumno de moodle
 tambien se eliminen los datos correspondientes al módulo de experiencia de dicho
 usuario.}
 ...
 \UCsection{Atributos}
	...
	\UCitems{Errores}{%
        ...
        % CAUSA
            ...
            instalados,}{%
        % EFECTO
            continua en el penúltimo paso de la trayectoria principal}

        \Titem \UCerr{Err2}{%
        % CAUSA
            El usuario que se desea eliminar ha sido eliminado previamente,}{%
        % EFECTO
            no se muestra la entrada del alumno en la pantalla \refElem{IU-M05a},
...
%
  ...
  \Sistema Elimina los datos de experiencia obtenidos en los cursos gamificados en
           los que el usuario ha sido \entrada{xp-alumn}.

...
%
 ...
 \UCsection[admin]{Datos de Administración de Requerimiento}
	...
	\UCitem[admin]{Observaciones}{%
        ...
        \refElem{xp-alumn}, \refElem{xp-user}, \refElem{xp-course-sections} y
...
%
  ...
  \Sistema Cambia los \entrada[formatos]{course.format} de los cursos por el formato de 
           secciones aplicando la regla \regla{BR-E06}.

  \Sistema Obtiene las \entrada[secciones de los curso gamificados]{xp-course-sections} 
           y las elimina.

  \Sistema Elimina los datos de todos los \entrada[alumnos gamificados]{xp-alumn} y 
           \entrada[usuarios gamificados]{xp-user} registrados en el sistema.

...
%
 \includeUC{CU-M01} presionando la pestaña {\bf Cursos}.
  ...
  \Actor Selecciona UN \entrada{mdl-course.format} distinto al \refElem[formato gamificado]%
         {xp-course.format}.
  ...
  \Sistema Elimina las \entrada[recompensas]{xp-section-reward} de las secciones del curso

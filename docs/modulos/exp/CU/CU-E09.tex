...
Cuando un estudiante conteste un ejercicio y suba un intento para revisión, el sistema le otorgará la experiencia correspondiente. Si recibe experiencia suficiente, el usuario subirá de nivel.
}
    ...
    \UCrow{Actor}{Estudiante} % Gerente, Instructor
    ...
    \UCrow{Precondiciones}{
		\begin{CUTitemize}
	        \CUTitem{El actor está registrado como estudiante del curso.}
	...
	\UCrow{Errores}{E1: El actor no está registrado como estudiante del curso}
    \UCrow{Observaciones}{}
\end{UseCase}

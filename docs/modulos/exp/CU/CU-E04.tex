...
\begin{UCtrayectoria}%
  ...
  \Sistema Crea un \salida{xp-course} con los valores de \salida{xp-course.hiddensections},
           \salida{xp-course.coursedisplay} y \salida{xp-course.xpEnabled} ingresados por el
           usuario.
  \Sistema Por cada una de las \salida[secciones]{xp-course.sections} del curso gamificado
           crea una \salida{xp-course-section}.
  \Sistema Establece la \salida{xp-course-section.xp} con base en la regla de negocio
           \regla{BR-E07}.
  \Sistema Muestra la pantalla con \refElem{IU-E06a} con los datos del curso recien creado.

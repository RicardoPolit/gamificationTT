...
\input{modulos/comp/CU/CU-C10}
\input{modulos/comp/CU/CU-C11}
    %\input{modulos/comp/CU/CU-C02}   % Configuraciones generales
    ...
    %\input{modulos/comp/CU/CU-C03}   % Desinstalar plugin del esquema de comperiencia
    %\input{modulos/comp/CU/CU-C04}   % Crear un curso gamificado
    %\input{modulos/comp/CU/CU-C05}   % Convertir un curso ordinario a uno gamificado
    %\input{modulos/comp/CU/CU-C06}   % Convertir Curso gamificado -> curso ordinario
    %\input{modulos/comp/CU/CU-C10}   % Climinar un curso gamificado
    %\input{modulos/comp/CU/CU-C12}   % Crear cuenta de un usuario gamificado
    %\input{modulos/comp/CU/CU-C13}   % Eliminar cuenta de un usuario gamificado

    %\input{modulos/modExpCU/CU-E02-1} % Configuraciones generales
    %\input{modulos/modExpCU/CU-E02-2} % Visualización de niveles
    %\input{modulos/modExpCU/CU-E02-3} % Esquema de experiencia
...
\subsubsection{Interfaces del módulo de competencia}
    ...
    \input{modulos/comp/IU/IU-C02}
    \input{modulos/comp/IU/IU-C02a}  % Configuraciones Visuales
    ...
    \input{modulos/comp/IU/IU-C09}
    \input{modulos/comp/IU/IU-C10}
    \input{modulos/comp/IU/IU-C11}
    \input{modulos/comp/IU/IU-C12}
    \input{modulos/comp/IU/IU-C13}  % Configuraciones Visuales

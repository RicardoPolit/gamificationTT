...
\subsubsection{Reglas de negocio} %========================================================
 ...
 antecediendo al número consecutivo en su identificador.
    ...
    %\input{modulos/comp/BR/BR-E01} % Restricciones sobre de imagen del nivel.
    %\input{modulos/comp/BR/BR-E02} % Permanencia del nivel de comperiencia.
...
\subsubsection{Interfaces del módulo de competencia}
    ...
    \input{modulos/moodle/IU/IU-M07}
    \input{modulos/moodle/IU/IU-M07aa}  % Configuraciones
    \input{modulos/moodle/IU/IU-M07a}
    \input{modulos/moodle/IU/IU-M07b}
    \input{modulos/moodle/IU/IU-M07c}  % Configuraciones
    ...
    \input{modulos/comp/IU/IU-C06}  % Configuraciones Visuales

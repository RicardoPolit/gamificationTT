...
\section{Interfaces del módulo de Experiencia}
    ...
    \input{modulos/IUMoodle/IU-M01}  % Administración del sitio
    \input{modulos/IUMoodle/IU-M01a} % Administración del sitio (Plugins)
    \input{modulos/IUMoodle/IU-M02}  % Install plugin (formulario)
    \input{modulos/IUMoodle/IU-M02a} % Install validación (ZIP)
    \input{modulos/IUMoodle/IU-M02b} % Install comprobación
    \input{modulos/IUMoodle/IU-M02c} % Install result (ok)
    \input{modulos/IUMoodle/IU-M02d} % Install cancelled

    %\input{modulos/IUMoodle/IU-M01a} % Resutlado de Instalación
    %\clearpage
    %\input{modulos/IUMoodle/IU-M01b} % Resutlado de Instalación
    %\clearpage
    %\input{modulos/IUMoodle/IU-M01}  % Cancelación de Instalación

    %\input{modulos/IUMoodle/IU-M02} % Pantalla principal
    %\input{modulos/IUMoodle/IU-M03} % Administración del Sitio Plugins

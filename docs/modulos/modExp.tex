...
\section{Reglas de negocio}
 ...
 antecediendo al número consecutivo en su identificador.
    ...
    \input{modulos/reglas/moodle}
    \input{modulos/reglas/experiencia}
...
\subsection{Diagrama de casos de uso}
 ...
 e instructivos como documentación de las funcionalidades que brinda.
    ...
    \input{modulos/moodleCU/CU-M01} % Acceder a la administración del sitio

    % MODULO DE EXPERIENCIA
    \input{modulos/modExpCU/CU-E01}   % Instalar plugin del esquema de experiencia
    \input{modulos/modExpCU/CU-E02}   % Configuraciones generales
    \input{modulos/modExpCU/CU-E02-1} % Configurar visualización de niveles
    \input{modulos/modExpCU/CU-E02-2} % Configurar esquema de experiencia
...
\section{Interfaces de Moodle}
    ...
    \input{modulos/moodleIU/IU-M00}  % Tablero (Dashboard)
    \input{modulos/moodleIU/IU-M00a}  % Form: Selector de archivos

    \input{modulos/moodleIU/IU-M01}  % Administración del sitio
    \input{modulos/moodleIU/IU-M01a} % Administración del sitio plugins

    \input{modulos/moodleIU/IU-M02}  % Instalación de Plugin
    \input{modulos/moodleIU/IU-M02a} % Validación de archivo ZIP
    \input{modulos/moodleIU/IU-M02b} % Comprobación de plugibs
    \input{modulos/moodleIU/IU-M02c} % Cancelación Instalación Plugin
    \input{modulos/moodleIU/IU-M02d} % Resultado Instalación Plugin

\section{Interfaces del módulo de experiencia}

    \input{modulos/modExpIU/IU-E01}  % Configuraciones
    \input{modulos/modExpIU/IU-E02}  % Configuraciones Generales
    \input{modulos/modExpIU/IU-E03}  % Configuraciones Visuales
    \input{modulos/modExpIU/IU-E03a} % Configuraciones Mod Exp desactivado
    \input{modulos/modExpIU/IU-E04}  % Configuraciones Esquema
...
\chapter{Pruebas}
    ...
    \input{modulos/modExpCP/CPC-E01}
    \input{modulos/modExpCP/CPC-E02}
    \input{modulos/modExpCP/CPC-E02-1}
    \input{modulos/modExpCP/CPI-E02-1a}
    \input{modulos/modExpCP/CPI-E02-1b}
    \input{modulos/modExpCP/CPC-E02-2}
    \input{modulos/modExpCP/CPI-E02-2a}
    \input{modulos/modExpCP/CPI-E02-2b}
    \input{modulos/modExpCP/CPI-E02-2c}

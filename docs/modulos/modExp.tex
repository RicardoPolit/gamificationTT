...
\section{Esquema de experiencia}
 ...
 uno de los grupos.\\
    ...
    %Esta entidad es únicamente una representación de las configuraciones correspondientes al módulo
    %de experiencia y no forma parte del modelo de datos ya que las configuraciones de todos los
    %plugins son almacenados en la entidad \refElem{Mdl-configuration}.}
        ...
        \brAttr{xpEvents}{eventosExp}{tBoolean}{%
            Valor que indica si se brinda experiencia a la lista de eventos
            \refElem{Configuracion.eventos}.\par
...
\subsection{Diagrama de casos de uso}
 ...
 e instructivos como documentación de las funcionalidades que brinda.
    ...
    \input{modulos/moodleCU/CU-M01} % Instalar plugin

    %\input{modulos/modExpCU/CU-E01} % Instalar configuración del esquema de experiencia
...
\section{Interfaces del módulo de experiencia}
    ...
    %\input{modulos/moodleIU/IU-E01} % Configuraciones

...
\section{Relaciones del módulo de experiencia}
 ...
 de datos de moodle que son relevantes para el desarrollo del módulo de experiencia.
    ...
    A pesar de que las configuraciones son almacenadas en la entidad \refElem{mdl-config-plugins}.
    ...
    generales del módulo de experiencia.}
        ...
        \brAttr{events}{eventosActivados}{tBoolean}{%
    ...
    De la misma forma que las configuraciones generales, las configuraciones visuales, los datos
    correspondientes a las configuraciones visuales son representados mediante esta entidad.}
        ...
        \brAttr{image}{Imagen}{tImage}{%
            ...
            \refElem{tDefault} ``http://www.escom.ipn.mx/images/escudoESCOM.jpg''
        }
    \end{cdtEntidad}

    \begin{cdtEntidad}{xp-scheme-settings}{Configuraciones de Comportamiento}{
    De la misma forma que las configuraciones generales, los datos correspondientes a las
    configuraciones visuales son representados mediante esta entidad.}
    ...
    De la misma forma que las configuraciones anteriores, los datos correspondientes a las
    configuraciones de eventos son representados mediante esta entidad.}
    \end{cdtEntidad}

    \begin{cdtEntidad}{xp-user}{Usuario gamificado}{%
    Esta entidad es una especialización de la entidad \refElem{mdl-user} la cual permite agregar
    atributos cómo la cantidad de experiencia obtenida y el nivel actual del usuario.}
        ...
        \brAttr{mdl-user}{mdl-usuario}{tInt}{%
            Es el número que permite conocer a que usuario de moodle pertecene la información
            de un usuario gamificado.\par
        ...
        \brAttr{level}{nivel}{tNatural}{%
            Representa el nivel actual de experiencia que tiene un usuario gamificado en moodle.\par

            \it Restricciones: Ninguna
        }

        \brAttr{xp}{experiencia}{tInt}{%
            Representa los puntos de experiencia que tiene un usuario en moodle

...
%
    ...
    \includeUC{CU-E01} a partir del paso \ref{CU-E03-formulario}
\end{UCtrayectoria}
...
{B}{El \refElem{aAdministrador} despues de la validación del archivo desea cancelar la instalación.}
...
\begin{UCtrayectoriaA}[Fin del caso de uso]%
{C}{El \refElem{aAdministrador} despues de ver la comprobación de plugins a instalar desea cancelar
la instalación}

...
\begin{UseCase}[Autor/Daniel Ortega,Version/0.0,Estado/\ucstEnEdicion]%
...
% \ucstAprobado      Al ser aprobado por el usuario (version += 1.0)
    {CU-E1}{Configurar Esquema de Experiencia
	...
	\UCitem{Actor(es)}{% Liste los actores debidamente referenciados (Dar de alta al actor).
		...
		\refElem{ID-del-autor-sin-espacios-ni-caracteres-especiales}
	}
...
%% <------------------------------------------ END-BLOQUE PARA AGREGAR UNA REVISION
	...
	%----------------------------------------------
	\UCsection{Atributos}
	\UCitems{Entradas}{% NO MODIFICAR ESTE ATRIBUTO:
	...
	\UCitems{Salida}{% NO MODIFICAR ESTE ATRIBUTO:
...
El administrador desea configurar el esquema de experiencia, entra a la interfaz  \hyperref[IUE03]{IU-E03 Configuración del esquema de experiencia}, modifica lo que desea, el sistema valida las entradas y las guarda.
	...
	\UCitem{Versión}{\color{gray} 0.2 (Revisado)}
    \UCitem{Autor}{\color{gray}	David Flores Casanova}
    \UCitem{Supervisa}{\color{gray}	Ricardo Naranjo Polit}
    \UCitem{Actor}{Administrador} % Gerente, Instructor

...
\input{modulos/seguimiento/CU/CU-S01}
\input{modulos/seguimiento/CU/CU-S02}
\input{modulos/seguimiento/CU/CU-S03}
\input{modulos/seguimiento/CU/CU-S04}
\input{modulos/seguimiento/CU/CU-S05}
...
\subsubsection{Interfaces del módulo de seguimiento}
    ...
    \input{modulos/seguimiento/IU/IU-S01}
    \input{modulos/seguimiento/IU/IU-S02}
    \input{modulos/seguimiento/IU/IU-S03}
    \input{modulos/seguimiento/IU/IU-S04}
    \input{modulos/seguimiento/IU/IU-S05}


\input{modulos/seguimiento/dis_plugins}

\subsection{Pruebas}
     %\input{modulos/exp/CP/CPC-E13}


\input{modulos/seguimiento/pruebas}

...
%
 ...
 \UCsection{Atributos}
	...
	\UCitems{Propósito}{%
        \Titem El actor desea ver el progreso que lleva en la activdad, así como ver, si ya respondió la pregunta diaria.
	}
...
\begin{UCtrayectoria}%
%
 	\Actor Presiona el nombre de la instancia de la actvidad a la que quiere acceder en la pantalla \refElem{IU-M07}.
...
\UCExtensionPoint{Responder pregunta diaria}{%
    ...
    El actor desea reponder la pregunta del día.
%

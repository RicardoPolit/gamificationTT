...
Permite al usuario (Ya sea un \refElem{aProfesor}, un \refElem{aAdministrador} o un \refElem{aEstudiante})
 ...
 \UCsection{Atributos}
	...
	\UCitem{Salidas}{
        \imprimeUC{salida}
        \Titem \refElem{MSG-F01}
        \Titem \refElem{MSG-F02}
        \Titem \refElem{MSG-F03}}
...
%
    ...
    \Sistema Desbloquea el objeto seleccionado para el actor, guardandolo en \refElem{tienda-gmdl-objeto-desbloqueado}.
    ...
    \Sistema Muestra el mensaje \refElem{MSG-P01}
...
\begin{UCtrayectoriaA}[Fin del caso de uso]%
  ...
  \Sistema Muestra el mensaje  \refElem{MSG-F02}.
...
{B}{El actor ya tiene comprado el objeto}
    ...
    \Sistema Muestra el mensaje \refElem{MSG-F03} 

...
\subsubsection{Reglas de negocio} %========================================================
 ...
 antecediendo al número consecutivo en su identificador.
    ...
    \input{modulos/person/BR/BR-P01}
\clearpage
...
\input{modulos/person/CU/CU-P01}   % Ver perfil gamificado
\input{modulos/person/CU/CU-P02}   % Modificar perfil gamificado
\input{modulos/person/CU/CU-P03}   % Eliminar datos del complemento
\input{modulos/person/CU/CU-P04}   % Activar complemento
...
\subsubsection{Interfaces del módulo de competencia}
    ...
    %\input{modulos/moodle/IU/IU-M00b}
    \input{modulos/moodle/IU/IU-M09}
    \input{modulos/moodle/IU/IU-M09a}
    \input{modulos/moodle/IU/IU-M10}
    \input{modulos/person/IU/IU-P01}


\input{modulos/person/dis_plugins}


\subsection{Pruebas}

\input{modulos/person/pruebas}
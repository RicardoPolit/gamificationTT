...
%
{CU-P05}{Desactivar complemento}{%
%
    Para desactivar el complemento se necesita que el actor\refElem{aAdministrador} haga unas modificaciones
    en la configuración de moodle. Esto ya es soportado por moodle, solo se indica qué es lo que debe de ingresar
    el actor. Este caso de uso es una extensión del caso de uso {\it Acceder a la administración del sitio} propio de moodle.}
 ...
 \UCsection{Atributos}
	...
	\UCitems{Propósito}{%
        \Titem Se quiere dejar de ver la opción de perfil gamificado.
	}
	...
	\UCitems{Precondiciones}{%
        \Titem se debió de haber ejecutado el CU 'Acceder a la administración del sitio'.
	}

	\UCitems{Postcondiciones}{%
        \Titem La cabecera de moodle dejará de contar con la opción de 'Perfil gamificado'.
        \Titem El submenú del usuario de moodle  dejará de contar con la opción de 'Perfil gamificado'.
	}
 ...
 \UCsection[design]{Datos de Diseño}
	...
	\UCitems[design]{Casos de Prueba}{%
        \Titem \refElem{CPC-P05-1}
        \Titem \refElem{CPI-P05-2}
        \Titem \refElem{CPI-P05-3}
	}

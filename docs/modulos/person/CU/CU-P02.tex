...
%
 ...
 \UCsection{Atributos}
	...
	\UCitems{Propósito}{%
        \Titem El usuario quiere modificar que objetos se mostrarán cuando se visualize su perfil gamificado en las actividades.
	}
	...
	\UCitems{Precondiciones}{%
        ...
        \Titem El usuario debe tener almenos un objeto desbloqueado.
        \Titem Los objetos seleccionados deben estár desbloqueado para el usuario.
	}

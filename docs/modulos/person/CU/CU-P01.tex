...
Permite a un usuario (Ya sea un \refElem{aProfesor}, un \refElem{aAdministrador} o un \refElem{aEstudiante})
 ...
 Este caso de uso es una extensión del caso de uso {\it Iniciar sesion} que es propio de moodle.}
 ...
 \UCsection{Atributos}
	...
	\UCitems{Propósito}{%
        \Titem El usuario quiere agragar un objeto más a su colección, para poder usarlo en la personalización de si perfil.
	}
	...
	\UCitems{Precondiciones}{%
        \Titem El usuario debió de haber ejecutado el CU {\it Iniciar sesion} que es propio de moodle.
	}
...
\UCExtensionPoint{Comprar objeto}{%
  ...
  %
      }{Al final de la trayectoria alternativ a C
  %
      }{\refElem{CU-F03}}

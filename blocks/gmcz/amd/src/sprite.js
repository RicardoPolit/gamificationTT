...
define(['jquery'], function($) {
    ...
    return {
        init: function(obj){
            ...
            // Create the canvas (Neccessary for IE because
            // it doesn't know what a canvas element is)
            ...
            // Note:
            //  The above code is a workaround for IE 8and lower.
            //  Otherwise we could have used:
            //  context = document.getElementById('canvas').getContext("2d");
        
            totalResources = obj.length;

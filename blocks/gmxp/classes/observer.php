...
class block_gmxp_observer {
    ...
    public static function assessable_submittedC(core\event\course_module_completion_updated $event){
        block_gmxp_observer::createSessionValues();
        $_SESSION['Gamedle']['Completion'] .= "\\\\".json_encode($event->get_data())." * ";
    }
    ...
    private static function createSessionValues(){
        ...
        if(!isset($_SESSION['Gamedle']['Completion'])) $_SESSION['Gamedle']['Completion'] = "";

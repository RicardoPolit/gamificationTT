...
$string['gmxp:addinstance']   = 'Agrega un nuevo bloque Gamedle level';
...
$string['typeOfIncrementA'] = 'Porcentaje';
...
$string['descDefMessage'] = 'Escrib tu propio menaje de felicitaciones cuando un usuario suba de nivel';
